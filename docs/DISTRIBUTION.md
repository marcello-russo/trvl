...
> AI travel agent with 1 smart MCP tool plus 62 compatibility aliases for flights, hotels, trains, buses, ferries, price alerts, hidden-city search, and award redemptions. Free core providers, no personal API keys, one Go binary.
